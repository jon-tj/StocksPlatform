...
import { HoldingsTable, ChildRow } from '../../components/holdings-table/holdings-table';
...
@Component({
  ...
  imports: [DecimalPipe, DatePipe, StockChart, OrderChart, SectorLabelPipe, ValueChip, GainChip, HoldingsTable],
